...
import PlanComidaUsuarioPage from '@/views/PlanComidaUsuarioPage.vue';
import DetallePlanComidaPage from '@/views/DetallePlanComidaPage.vue';
import MenuUsuarioPage from '@/views/MenuUsuarioPage.vue';
import Usuario1Page from '@/views/Usuario1Page.vue';
...
const routes: Array<RouteRecordRaw> = [
  ...
  {
    path: '/planes',
    name: 'ListaPlanUsuario',
    component: PlanComidaUsuarioPage
  },
  {
    path: '/detalles-plan/:id',
    name: 'DetallesPlan',
    component: DetallePlanComidaPage
  },
  {
    path: '/menuusuario',
    name: 'MenuUsuario',
