...
<template>
  <ion-page>
    ...
    <ion-content class="ion-padding">
      <ion-grid>
        ...
        <ion-row>
          <ion-col>
            ...
            <ion-item>
              <ion-input v-model="tiempoDePreparacion" placeholder="Tiempo de Preparación"></ion-input>
            </ion-item>
          </ion-col>
        </ion-row>
        <ion-row>
      ...
      <ion-button @click="navigateTo('agregar-ingredientes')" expand="full" color="success">Agregar Ingredientes</ion-button>
    </ion-content>
  </ion-page>
</template>
...
const guardarReceta = async () => {
  const receta = {
    ...
    tiempoDePreparacion: tiempoDePreparacion.value,
