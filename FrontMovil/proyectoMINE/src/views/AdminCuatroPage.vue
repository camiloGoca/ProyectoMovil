  ...
  <ion-page>
    ...
    <ion-content class="ion-padding">
      <ion-grid>
        ...
        <ion-row>
          <ion-col>
            <ion-button expand="full" color="success" @click="navigateTo('admin1')">Ir al Inicio</ion-button>
          </ion-col>
        </ion-row>
        <!-- Sección de edición de receta -->
                ...
                <ion-grid>
                  ...
                  <ion-row>
                    <ion-col>
                      ...
                      <ion-item>
                        <ion-input v-model="editReceta.tiempoDePreparacion" placeholder="Tiempo de Preparación"></ion-input>
                      </ion-item>
                    </ion-col>
                  </ion-row>
                  <ion-row>
